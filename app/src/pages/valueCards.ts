...
export const valueCards: ValueCard[] = [
  ...
  {
    title: 'Gold Standard in Supply Chain Data',
    description:
      'TMG provides premium supply chain data as a service ensuring the foundation of ERP systems are based on complete, accurate and relevant data records, enabling insightful analytics for optimal decision-making.',
